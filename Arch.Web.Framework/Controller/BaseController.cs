...
namespace Arch.Web.Controllers
{
    public class BaseController : Controller
    {
        ...
        {
            return AjaxMessage(MessageTitleTypes.Tebrikler, "Transaction completed successfully.", MessageTypes.success);
        }

        public ActionResult AjaxBad()
        {
            return AjaxMessage(MessageTitleTypes.Uyari, "User not created.", MessageTypes.danger);
        }
